...
/// Optimized ThrottleCrab client with connection pooling
#[derive(Clone)]
...
impl ClientBuilder {
    ...
    /// Build the client
    pub async fn build<A: ToSocketAddrs>(self, addr: A) -> Result<ThrottleCrabClient> {
        ...
        let pool = Arc::new(ConnectionPool::new(addr, self.config));
...
mod tests {
    ...
    async fn test_connect_and_basic_request() {
        ...
        let client = ThrottleCrabClient::connect(addr).await.unwrap();
    ...
    async fn test_builder_with_custom_config() {
        ...
        let client = ThrottleCrabClient::builder()
    ...
    async fn test_invalid_address() {
        ...
        let result = ThrottleCrabClient::connect("invalid_address").await;
    ...
    async fn test_connection_refused() {
        ...
        let result = ThrottleCrabClient::connect("127.0.0.1:54321").await;
    ...
    async fn test_client_clone() {
        ...
        let client1 = ThrottleCrabClient::connect(addr).await.unwrap();
